 ...
 */
@Entity
@Table(name = "outreach_not_registered")
public class OutReachNotRegisteredDTO {
	@Id
	...
	public OutReachNotRegisteredDTO() {
		super();
	}

	public OutReachNotRegisteredDTO(String eventId, String eventName, String beneficiaryName, String baseLocation,
