...
@Api
@ApiModel(value="outReachNotRegisteredRspVo")
@JsonInclude(value = Include.NON_EMPTY)
public class OutReachNotRegisteredRspVo implements Serializable{
	
	private static final long serialVersionUID = 4626811633731100208L;
	...
	public OutReachNotRegisteredRspVo() {
		super();
	}

	public OutReachNotRegisteredRspVo(String eventId, String eventName, String beneficiaryName, String baseLocation,
